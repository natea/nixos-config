...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Nate Aune"
    user-mail-address "natejaune@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/backlit/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/backlit/bin" "/profile/bin" "/Users/backlit/.npm-packages/bin" "/Users/backlit/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
